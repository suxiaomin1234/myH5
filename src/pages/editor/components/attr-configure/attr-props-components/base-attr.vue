<template>
  <div>
    ...
    <el-collapse v-model="activeNames">
      ...
      <el-collapse-item title="块阴影样式：" name="3">
        <div class="attr-item-edit-wrapper">
        ...
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">阴影设置：</p>
          <div class="col-2 attr-item-edit-input">
            <el-input-number
              size="mini"
              @change="boxShadowChange"
              ...
              controls-position="right"
            />
            <div class="attr-item-edit-input-des">模糊距离</div>
          </div>
          <div class="col-2 attr-item-edit-input">
            <el-input-number
              size="mini"
              ...
              controls-position="right"
            />
            <div class="attr-item-edit-input-des">阴影的大小</div>
          </div>
        </div>
        <div class="attr-item-edit-wrapper">
      ...
      <el-collapse-item title="字体阴影样式：" name="6" v-if="noShow">
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">阴影位置：</p>
          <div class="col-2 attr-item-edit-input">
            <el-input-number
              size="mini"
              @change="textShadowChange"
              v-model="textShadow.h"
              controls-position="right"
            />
            <div class="attr-item-edit-input-des">水平阴影位置</div>
          </div>
      ...
      <el-collapse-item title="字体：" name="4">
        <div class="attr-item-edit-wrapper">
          <p class="attr-item-title">排列方向：</p>
          <div class="col-2 attr-item-edit-input">
            <el-select
              class="fontFamilyBox"
              v-model="activeElement.commonStyle.writingMode"
              @change="throttleAddHistory"
              size="mini"
            >
              <el-option
                v-for="item in writingMode"
                :key="item.value"
                :label="item.name"
                :value="item.value"
              />
      ...
      <el-collapse-item title="背景和透明度：" name="5">
        <div class="attr-item-edit-wrapper">
...
import fontCssData from "@src/common/styles/fonts/fonts.js";
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      noshowData:(state) => state.editor.noshow,
    }),
    ...mapGetters([
      "currentPageIndex",
      "activeElementIndex",
  ...
  created() {
    ...
    this.fontCssData = fontCssData;
    this.noShow = this.noshowData
  },
  mounted() {
    this.initBoxShadowEdit();
  ...
  methods: {
     ...
     */
    initTextShadowEdit() {
      let textShadow = this.activeElement.commonStyle.textShadow;
      let textShadowEditConfig = {
        h: 0,
        v: 0,
        blur: 0,
        color: "#000000",
      ...
      if (!textShadow || textShadow === "none") {
        this.textShadow = textShadowEditConfig;
        return;
      }
      let str = textShadow.split(" ");

      textShadowEditConfig = {
        h: parseInt(str[0].replace("px", "")),
        v: parseInt(str[1].replace("px", "")),
        blur: parseInt(str[2].replace("px", "")),
        color: str[4],
     ...
     */
    textShadowChange() {
      let str = `${this.textShadow.h}px ${this.textShadow.v}px  ${this.textShadow.blur}px  ${this.textShadow.color}`;
      this.activeElement.commonStyle.textShadow = str;
    },
    /**
     * 字体样式设置对齐方式
     * @param str
