...
const mutations = {
	...
	addHistoryCache(state) {
		console.log('新增历史记录',state.currentHistoryIndex,state)
	...
	setMusicObj(state, data) {
		if(state.musicUrlObj) state.musicUrlObj = "";
